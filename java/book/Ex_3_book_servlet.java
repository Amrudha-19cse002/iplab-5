...
throws ServletException, IOException {
        ...
        try(PrintWriter out = response.getWriter()){
            if(copies<=book.stock)
            {
               ...
               text-align:center;background-color:#98FB98;font-size:large;'><tr><td>  colspan='2'>Receipt</td>");
...
out.println("<form method='get' action='http://localhost:8080/IP_LAB_EXERCISES/Ex_3_book_servlet'>");
